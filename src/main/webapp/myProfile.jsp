	...
	<div class="container mt-3 mb-5">
		<div class="d-flex justify-content-center row">
			<div id="left-sidebar" class="sidebar col-md-2">
				<div class="side-menu row justify-content-start align-items-center">
					<i class="fa fa-home fa-2x"></i><a href="Home"><h5 class="ml-2 mt-2">Home</h5></a>
				</div>
				<div class="side-menu row justify-content-start align-items-center">
					<i class="fa fa-user fa-2x"></i><a href="Profile?user_id=${sessionScope.user_id}"><h5 class="ml-2 mt-2">Profile</h5></a>
				</div>
				<div class="side-menu row justify-content-start align-items-center">
					<i class="fa fa-comments fa-2x"></i><a href="Messages"><h5 class="ml-2 mt-2">Messages</h5></a>
				</div>
				...
				<div class="feed">
					<div class="share border bg-white">
						<div class="profile-picture">
							<img class="rounded-circle" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg" width="110" width="110">
						</div>
						<div class="border-top bg-white profile-info">
							<h5>${sessionScope.username}</h5>
							<h5>Joined date</h5>10/05/2021
							<h5>Birthday</h5>10/05/2021
						</div>
					</div>
				</div>
					<div class="border pl-1 pt-1 mt-2" id="requests" user_id="${sessionScope.user_id}">
						<h6>Friend requests</h6>
						<div class="friend-request">
							<c:forEach items="${frequests}" var="r">
								<div class="mt-2">
									<a href="ViewUser?user_id=${r.get(0)}">${r.get(1)}</a> <button class="btn btn-primary btn-sm accept-btn" user_id1="${sessionScope.user_id}" user_id2="${r.get(0)}">Accept</button><br>
								</div>
							</c:forEach>
						</div>
					</div>
					<div class="border pl-1 pt-1 mt-2">
						<h6>Timeline</h6>
					</div>
				<div id="feeds" class="feeds">
					<c:forEach items="${posts}" var="post">
	                <div class="feed-post mt-2 border" post_id="${post.get(0)}">
	                        ...
	                        <div class="d-flex flex-row justify-content-between align-items-start profile">
	                            <div class="d-flex align-items-center"><img class="rounded-circle img-responsive" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg" width="50" height="50">
	                                <div class="d-flex flex-column ml-2">
	                                    <h6>${post.get(6)}</h6><span class="time">${post.get(2)}</span>
	                                </div>
...
<script>
	...
	$('.show-cmt-btn').click(function(e){
		...
		//show comments
	 	$(this).parent().children().html('<a>All comments</a>');
	...
	//tu dong check da like bai viet hay chua, load nut like mau xanh, load friend requests
