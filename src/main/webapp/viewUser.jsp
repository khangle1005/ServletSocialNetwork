			...
			<div class="col-md-8">
				<div class="feed">
					...
					<div class="border pl-1 pt-1 mt-2">
						<c:if test = "${check_friend == 'friend'}">
							<button id="unfriend-btn" class="btn btn-primary" user_id1="${sessionScope.user_id}" user_id2="${user_id2}">Unfriend</button>
      					</c:if>
      					<c:if test = "${check_friend == 'notfriend'}">
							<button id="addfriend-btn" class="btn btn-primary" user_id1="${sessionScope.user_id}" user_id2="${user_id2}">Add friend</button>
      					</c:if>
      					<c:if test = "${check_friend == 'me'}">
						</c:if>
					</div>
					<div class="border pl-1 pt-1 mt-2">
						<h6>Timeline</h6>
